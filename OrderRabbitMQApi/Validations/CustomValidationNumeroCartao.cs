...
public class CustomValidationNumeroCartao : ValidationAttribute
{
    ...
    public CustomValidationNumeroCartao()
    {
        _cardTypes = CardType.All;
    }

    public CustomValidationNumeroCartao(CardType AcceptedCardTypes)
    {
    ...
    {
        return "O campo contém um número de cartão de crédito inválido, não use (,) ou(-) USE -> EX.: XXXXXXXXXXXXXXXX.";
    }
